...
// S=-7, P=35, KI 5, KD 10 - Slow oscilations on carpet, cant react quit enough on table

//SETPOINT angle and PID constants
#define SETPOINT  ((float)(-4.5)) //-8.5 rob 1 // -7 rob 2
#define KP        35
#define KI        10 // 10
#define KD        20 // 20
...
void setup()
{
  ...
  digitalWrite(13, HIGH); //turn on user LED
  ...
  //lcd.clear();
  digitalWrite(13, LOW); //turn off user LED
